...
#Solution took 560ms runtime initially when i used min function in get min. However with current approach it took only 56 ms. Again, note sure why is that.
